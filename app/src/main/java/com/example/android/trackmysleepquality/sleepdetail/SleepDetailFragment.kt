...
class SleepDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sleepDetailViewModel.sleepNight.observe(viewLifecycleOwner, Observer {
            binding.qualityString.text =
                convertNumericQualityToString(it.sleepQuality, this.resources)
            binding.sleepLength.text =
                convertDurationToFormatted(it.startTimeMilli, it.endTimeMilli, this.resources)
            binding.qualityImage.setImageResource(setSleepImage(it))
        })
    ...
    private fun setSleepImage(it: SleepNight?): Int =
